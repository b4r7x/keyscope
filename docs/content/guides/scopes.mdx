---
title: Scopes
description: Scopes guide for keyscope hooks and patterns.
---

# Scopes

> Try the [Scoped Dialog demo](https://github.com/b4r7x/keyscope/tree/main/examples/playground) to see scopes in action.
