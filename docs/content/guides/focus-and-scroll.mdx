...
description: Focus And Scroll guide for keyscope hooks and patterns.
---

# Focus and Scroll

> Try the [Focus Trap demo](https://github.com/b4r7x/keyscope/tree/main/examples/playground) to see focus trapping in action.
