/**
 * Shiki-compatible CSS variables theme for docs code blocks.
 *
 * Variable references resolve against --code-* vars in styles/theme.css.
 * This object follows the TextMate theme format that Shiki expects.
 */
